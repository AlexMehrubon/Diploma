...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./app/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./app/public/storage',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','saloon.default_sender','saloon.integrations_path',
...
'sanctum.csrf-cookie','index','create','store',
'show','edit','update','destroy','storage.local',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','RABBITMQ_HOST',
