...
const module = ref({
  ...
  description : '',
  order: '',
  course_id: props.coursesStore.currentEditCourse.id
})
    ...
    <div class="relative p-4 w-1/2 max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow-sm">
        ...
        <div
          ...
          <button @click="props.moduleStore.switchCreateModal" type="button"
        ...
        <div class="py-4 px-7">
          <form class="space-y-4" action="#">
            ...
            <div class="mt-10 mb-10 mx-30 px-40">
              <button
                @click="props.moduleStore.createModule(module)"
                v-if="!props.moduleStore.isCreating"
